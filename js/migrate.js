window.migrateToFirebase = async function() {
  ...
  var SUPABASE_URL = 'https://qayhutfedlhzhtrlserh.supabase.co';
  var SUPABASE_KEY = 'sb_publishable_NoUBNfjDdpbJJgBDsdpKxw_K9IEg4UP';
  ...
  console.log('subs:', subsRes.data?.length, 'products:', prodsRes.data?.length, 'ads:', adsRes.data?.length, 'requests:', reqsRes.data?.length);
